    ...
    <motion.div className="w-full grid grid-cols-1 md:grid-cols-2 gap-4">
      <div className="flex flex-col items-start justify-start gap-6">
        ...
        <p className=" text-textColor text-lg">
          ...
          pariatur fuga porro deserunt, adipisci, cumque alias optio corporis
          delectus esse dolor iure debitis nihil soluta aspernatur. Dolorum ad
          ea numquam amet, necessitatibus et excepturi vel magnam, iure illo
          veniam! Voluptas ipsam provident tempora numquam distinctio a rerum
      ...
      <div className="py-2 flex-1 flex items-center justify-end relative">
        ...
        />
        <div className="w-full md:460 ml-0 flex flex-wrap items-center justify-center gap-4 gap-y-14">
          {randomData &&
            randomData.map((data, i) => (
              <motion.div
                key={i}
                {...staggerFadeInOut}
                className="w-32 h-36 md:w-190 p-4 bg-cardOverlay backdrop-blur-md rounded-3xl flex flex-col items-center justify-center drop-shadow-lg"
              >
                <img
                  src={data.imageURL}
                ...
                <p className="text-[12px] text-center md:text-base text-cardOverlay font-semibold capitalize">
