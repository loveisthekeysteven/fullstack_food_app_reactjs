...
//             Total: <TbCurrencyNaira className="text-lg text-red-500" />
...
//                 {...buttonClick}
//                 className={`text-orange-500 text-base font-semibold capitalize border border-gray-300 px-2 rounded-md cursor-pointer`}
//               >
//                 Preparing
//               </motion.p>
//               <motion.p
//                 onClick={() => handleClick(data.orderId, "preparing")}
//                 {...buttonClick}
//                 className={`text-red-500 text-base font-semibold capitalize border border-gray-300 px-2 rounded-md cursor-pointer`}
//               >
//                 cancelled
//               </motion.p>
//               <motion.p
//                 onClick={() => handleClick(data.orderId, "preparing")}
//                 {...buttonClick}
//                 className={`text-emerald-500 text-base font-semibold capitalize border border-gray-300 px-2 rounded-md cursor-pointer`}
//               >
//                 delivered
//               </motion.p>
//             </div>
...
//                     </p>
//                     <p className="flex items-center gap-1 text-textColor">
//                       <TbCurrencyNaira className="text-base text-red-500" />
