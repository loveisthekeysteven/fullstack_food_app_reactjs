...
import { Avatar, LogoBg } from "../assets";
...
import { setCartOn } from "../context/actions/displayCardAction";
  ...
  return (
    <header className="fixed backdrop-blur-md z-50 inset-x-0 top-0 flex items-center justify-between px-12 md:px-20 py-6">
      <NavLink to={"/"} className="flex items-center justify-center gap-4">
        <img src={LogoBg} className="w-12" alt="" />
      ...
      <nav className="flex items-center justify-center gap-8">
        ...
        {user ? (
          <>
            ...
            >
              <div className="w-12 h-12 rounded-full shadow-md cursor-pointer overflow-hidden flex items-center justify-center  bg-slate-900">
                <motion.img
          ...
          <>
            <NavLink to={"/login"}>
              <motion.button
                {...buttonClick}
                className="px-4 py-4 rounded-md shadow-md bg-cardOverlay border border-red-300 cursor-pointer"
              >
                Login
              </motion.button>
            </NavLink>
